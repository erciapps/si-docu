...
:::danger ANTES DE CONTINUAR
En caso de haber encriptado el disco, será necesario desactivarlo. Para ello elimina el TPM:
<figure>
  <img src="/img/encryp1.png" alt="encryp1" width="400" />
</figure>
Y desactiva el cifrado:
<figure>
  <img src="/img/encryp2.png" alt="encryp2" width="400" />
</figure>
...
5. Crea las siguientes particiones: 
   - Partición de 35mb con formato FAT32 con etiqueta de volumen: Identificador_iniciales_F32
   - Partición de 65mb con formato NTFS
...
4. Abre una terminal e instala **GParted**:
...
5. Localiza el disco correspondiente (por ejemplo, **/dev/sdb**), que ya contiene las particiones creadas en **Windows**.
...
6. En el espacio **no asignado**, crea las siguientes particiones:
   ...
   - **Partición de 50 MB** con formato **NTFS**, etiqueta de volumen:  
