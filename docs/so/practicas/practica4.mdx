...
<div class="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
  ...
  <div>
    <span class="font-medium">Organización de la práctica:</span>
    <ul class="mt-1.5 list-disc list-inside">
      <li>La primera parte se realiza en grupos de cuatro/cinco personas sobre equipos físicos, creando una copia de seguridad completa del sistema operativo en un dispositivo de red.</li>
      <li>Posteriormente, por parejas, se restaura esa misma copia en un entorno virtual equivalente.</li>
      <li>Esta organización permite optimizar los recursos disponibles y garantizar que todo el alumnado complete el proceso completo de backup y restauración.</li>
    </ul>
  </div>
</div>
...
## PARTE 2 RESTAURAR COPIA (PRÁCTICA POR PAREJAS)

:::danger ANTES DE EMPEZAR
ES IMPRESCINDIBLE AJUSTAR EL SISTEMA OPERATIVO COMO LINUX - UBUNTU 64bits PARA UN CORRECTO FUNCIONAMIENTO.
<figure>
  <img src="/img/clonezilla/vmsettings8.png" alt="vmsettings8" width="400" />
</figure>
* Crea un dispositivo virtual de al menos **520GB** (no te preocupes ya que no ocupará ese espacio realmente ya que unicamente usará el espacio real que ocupe)
* Crea ese dispositivo virtual en una ubicación de tu equipo físico, que al menos disponga de 25GB (que es lo que realmente ocupará las particiones de disco).
<figure>
  <img src="/img/clonezilla/vmsettings8.png" alt="vmsettings8" width="400" />
</figure>
:::
...
:::info ACTIVIDAD
* Realiza todos los pasos necesarios para realizar una restauración en uan máquina virtual de tu equipo, 
del backup realizado en la primera parte de la práctica.   
...
<EntregaCard
  ...
  date="14/11/2025"
  time="23:30"
  link="https://aulasciclos2526.castillalamancha.es/mod/assign/view.php?id=705492"
/>